...
public class ComputerServerApplication {
	...
	CommandLineRunner run(ServerRepo serverRepo){
		return args -> {
			...
			serverRepo.save(new Server(null, "192.168.1.190", "Ubuntu Linux", "16 GB", "Company PC", "http://localhost:8080/server/image/donate.png", Status.SERVER_UP));
			serverRepo.save(new Server(null, "192.168.1.140", "Ubuntu Linux", "16 GB", "Personal PC", "http://localhost:8080/server/image/finance.png", Status.SERVER_UP));
		};
	}
